...
public class Place extends Weibo
{
    ...
    {
		return Status
				.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/friends_timeline.json", access_token));
	}
			...
			throws WeiboException
    {
		...
		return Status
				.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/friends_timeline.json", parList, access_token));
	}
    ...
    {
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/user_timeline.json", new PostParameter[]{new PostParameter("uid", uid)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/user_timeline.json", parList, access_token));
	}
    ...
    {
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/poi_timeline.json", new PostParameter[]{new PostParameter("poiid", poiid)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/poi_timeline.json", parList, access_token));
	}
	...
	public StatusWapper nearbyTimeLine(String lat, String lon)
			throws WeiboException
    {
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/nearby_timeline.json", new PostParameter[]{new PostParameter("lat", lat), new PostParameter("long", lon)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/nearby_timeline.json", parList, access_token));
	}
    ...
    {
		return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/users/checkins.json", new PostParameter[]{new PostParameter("uid", uid)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/users/checkins.json", parList, access_token));
	}
    ...
    {
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/users/photos.json", new PostParameter[]{new PostParameter("uid", uid)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/users/photos.json", parList, access_token));
	}
	...
	public List<Places> poisShow(String poiid, int base_app)
			throws WeiboException
    {
		return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/pois/show.json", new PostParameter[]{new PostParameter("poiid", poiid), new PostParameter("base_app", base_app)}, access_token));
	}
    ...
    {
		return User.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "place/pois/users.json", new PostParameter[]{new PostParameter("poiid", poiid)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return User.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "place/pois/users.json", parList, access_token));
	}
    ...
    {
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/pois/photos.json", new PostParameter[]{new PostParameter("poiid", poiid)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/pois/photos.json", parList, access_token));
	}
    ...
    {
		return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/pois/search.json", new PostParameter[]{new PostParameter("keyword", keyword)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/pois/search.json", parList, access_token));
	}
    ...
    {
		return PoisitionCategory.constructPoisCategory(client.get(WeiboConfig.getValue("baseURL") + "place/pois/category.json", access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return PoisitionCategory.constructPoisCategory(client.get(WeiboConfig.getValue("baseURL") + "place/pois/category.json", parList, access_token));
	}
	...
	public List<Places> nearbyPois(String lat, String lon)
			throws WeiboException
    {
		return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/pois.json", new PostParameter[]{new PostParameter("lat", lat), new PostParameter("long", lon)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/pois.json", parList, access_token));
	}
    ...
    {
		return User.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/users.json", new PostParameter[]{new PostParameter("lat", lat), new PostParameter("long", lon)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return User.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/users.json", parList, access_token));
	}
	...
	public StatusWapper nearbyPhoto(String lat, String lon)
			throws WeiboException
    {
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/photos.json", new PostParameter[]{new PostParameter("lat", lat), new PostParameter("long", lon)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/photos.json", parList, access_token));
	}
