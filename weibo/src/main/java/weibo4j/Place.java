...
public class Place extends Weibo {
    ...
    public StatusWapper friendsTimeLine() throws WeiboException {
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/friends_timeline.json", access_token));
    }
    ...
    public StatusWapper friendsTimeLine(Map<String, String> map) throws WeiboException {
        ...
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/friends_timeline.json", parList, access_token));
    }
    ...
    public StatusWapper userTimeLine(String uid) throws WeiboException {
        return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/user_timeline.json",
    ...
    public StatusWapper userTimeLine(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/user_timeline.json", parList, access_token));
    }
    ...
    public StatusWapper poisTimeLine(String poiid) throws WeiboException {
        return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/poi_timeline.json",
                new PostParameter[]{new PostParameter("poiid", poiid)}, access_token));
    }
    ...
    public StatusWapper poisTimeLine(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/poi_timeline.json", parList, access_token));
    }
    ...
    public StatusWapper nearbyTimeLine(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/nearby_timeline.json", parList, access_token));
    }
    ...
    public Status statusesShow(String id) throws WeiboException {
        return new Status(client.get(WeiboConfig.getValue("baseURL") + "place/statuses/show.json",
    ...
    public JSONObject userInfoInLBS(String uid) throws WeiboException {
        return client.get(WeiboConfig.getValue("baseURL") + "place/users/show.json",
                new PostParameter[]{new PostParameter("uid", uid)}, access_token).asJSONObject();
    }
    ...
    public List<Places> checkinsList(String uid) throws WeiboException {
        return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/users/checkins.json",
                new PostParameter[]{new PostParameter("uid", uid)}, access_token));
    }
    ...
    public List<Places> checkinsList(Map<String, String> map) throws WeiboException {
        ...
        return Places.constructPlace(
                client.get(WeiboConfig.getValue("baseURL") + "place/users/checkins.json", parList, access_token));
    }
    ...
    public StatusWapper userPhotoList(String uid) throws WeiboException {
        return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/users/photos.json",
                new PostParameter[]{new PostParameter("uid", uid)}, access_token));
    }
    ...
    public StatusWapper userPhotoList(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/users/photos.json", parList, access_token));
    }
    ...
    public Places poisShow(String poiid) throws WeiboException {
        return new Places(client.get(WeiboConfig.getValue("baseURL") + "place/pois/show.json",
                new PostParameter[]{new PostParameter("poiid", poiid)}, access_token));
    }
    ...
    public List<Places> poisShow(String poiid, int base_app) throws WeiboException {
        return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/pois/show.json",
                new PostParameter[]{
    ...
    public UserWapper poisUsersList(String poiid) throws WeiboException {
        return User.constructWapperUsers(client.get(WeiboConfig.getValue("baseURL") + "place/pois/users.json",
                new PostParameter[]{new PostParameter("poiid", poiid)}, access_token));
    }
    ...
    public UserWapper poisUsersList(Map<String, String> map) throws WeiboException {
        ...
        return User.constructWapperUsers(
                client.get(WeiboConfig.getValue("baseURL") + "place/pois/users.json", parList, access_token));
    }
    ...
    public User poisTipsList(String poiid) throws WeiboException {
        return new User(client.get(WeiboConfig.getValue("baseURL") + "place/pois/tips.json",
                new PostParameter[]{new PostParameter("poiid", poiid)}, access_token).asJSONObject());
    }
    ...
    public StatusWapper poisPhotoList(String poiid) throws WeiboException {
        return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/pois/photos.json",
                new PostParameter[]{new PostParameter("poiid", poiid)}, access_token));
    }
    ...
    public StatusWapper poisPhotoList(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/pois/photos.json", parList, access_token));
    }
    ...
    public List<Places> poisSearch(String keyword) throws WeiboException {
        return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/pois/search.json",
                new PostParameter[]{new PostParameter("keyword", keyword)}, access_token));
    }
    ...
    public List<Places> poisSearch(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Places.constructPlace(
                client.get(WeiboConfig.getValue("baseURL") + "place/pois/search.json", parList, access_token));
    }
    ...
    public List<PoisitionCategory> poisCategory() throws WeiboException {
        return PoisitionCategory.constructPoisCategory(
                client.get(WeiboConfig.getValue("baseURL") + "place/pois/category.json", access_token));
    }
    ...
    public List<PoisitionCategory> poisCategory(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return PoisitionCategory.constructPoisCategory(
                client.get(WeiboConfig.getValue("baseURL") + "place/pois/category.json", parList, access_token));
    }
    ...
    public List<Places> nearbyPois(String lat, String lon) throws WeiboException {
        return Places.constructPlace(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/pois.json",
                new PostParameter[]{
                        new PostParameter("lat", lat),
                        new PostParameter("long", lon)
                }, access_token));
    ...
    public List<Places> nearbyPois(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Places.constructPlace(
                client.get(WeiboConfig.getValue("baseURL") + "place/nearby/pois.json", parList, access_token));
    }
    ...
    public UserWapper nearbyUsers(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return User.constructWapperUsers(
                client.get(WeiboConfig.getValue("baseURL") + "place/nearby/users.json", parList, access_token));
    }
    ...
    public StatusWapper nearbyPhoto(String lat, String lon) throws WeiboException {
        return Status.constructWapperStatus(client.get(WeiboConfig.getValue("baseURL") + "place/nearby/photos.json",
                new PostParameter[]{
                        new PostParameter("lat", lat),
                        new PostParameter("long", lon)
                }, access_token));
    ...
    public StatusWapper nearbyPhoto(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return Status.constructWapperStatus(
                client.get(WeiboConfig.getValue("baseURL") + "place/nearby/photos.json", parList, access_token));
    }
    ...
    public Status addCheckin(String poiid, String status) throws WeiboException {
        return new Status(
                client.post(WeiboConfig.getValue("baseURL") + "place/pois/add_checkin.json", new PostParameter[]{
                        new PostParameter("poiid", poiid),
    ...
    public Status addCheckin(String poiid, String status, ImageItem item) throws WeiboException {
        return new Status(
                client.multPartURL(WeiboConfig.getValue("baseURL") + "place/pois/add_checkin.json", new PostParameter[]{
                        new PostParameter("poiid", poiid),
                        new PostParameter("status", status)
                }, item, access_token));
    }
    ...
    public Status addCheckin(Map<String, String> map) throws WeiboException {
        PostParameter[] parList = ArrayUtils.mapToArray(map);
        return new Status(
                client.post(WeiboConfig.getValue("baseURL") + "place/pois/add_checkin.json", parList, access_token));
    }
    ...
    public Status addPhoto(String poiid, String status) throws WeiboException {
        return new Status(
                client.post(WeiboConfig.getValue("baseURL") + "place/pois/add_photo.json", new PostParameter[]{
                        new PostParameter("poiid", poiid),
                        new PostParameter("status", status)
                }, access_token));
    }
    ...
    public Status addTip(String poiid, String status) throws WeiboException {
        return new Status(client.post(WeiboConfig.getValue("baseURL") + "place/pois/add_tip.json", new PostParameter[]{
                new PostParameter("poiid", poiid),
                new PostParameter("status", status)
        }, access_token));
    }
     ...
     * @param poiid  需要签到的POI地点ID
     * @param status 签到时发布的动态内容，必须做URLencode，内容不超过140个汉字
     * @param pub    是否同步到微博，1：是、0：否，默认为0
     * @return
     * @throws weibo4j.model.WeiboException when Weibo service or network is unavailable
     * @version weibo4j-V2 1.0.2
     * @see http://open.weibo.com/wiki/2/place/pois/add_tip
