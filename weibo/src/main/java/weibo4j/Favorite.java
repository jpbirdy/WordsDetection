...
public class Favorite extends Weibo
{
    ...
    {
		return Favorites.constructFavorites(client.get(WeiboConfig.getValue("baseURL") + "favorites.json", access_token));
	}
    ...
    {
		return Favorites.constructFavorites(client.get(WeiboConfig.getValue("baseURL") + "favorites.json", null, page, access_token));
	}
			...
			throws WeiboException
    {
		...
		return Favorites.constructFavorites(client.get(WeiboConfig.getValue("baseURL") + "favorites.json", parList, access_token));
	}
    ...
    {
		return FavoritesIds.constructFavoritesIds(client.get(WeiboConfig.getValue("baseURL") + "favorites/ids.json", access_token));
	}
    ...
    {
		return Favorites.constructFavorites(client.get(WeiboConfig.getValue("baseURL") + "favorites/by_tags.json", new PostParameter[]{new PostParameter("tid", tid)}, access_token));
	}
	...
	public List<Favorites> getFavoritesByTags(String tid, Paging page)
			throws WeiboException
    {
		return Favorites.constructFavorites(client.get(WeiboConfig.getValue("baseURL") + "favorites/by_tags.json", new PostParameter[]{new PostParameter("tid", tid)}, page, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Favorites.constructFavorites(client.get(WeiboConfig.getValue("baseURL") + "favorites/by_tags.json", parList, access_token));
	}
    ...
    {
		return Tag.constructTag(client.get(WeiboConfig.getValue("baseURL") + "favorites/tags.json", access_token));
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Tag.constructTag(client.get(WeiboConfig.getValue("baseURL") + "favorites/tags.json", parList, access_token));
	...
	public List<FavoritesIds> getFavoritesIdsByTags(String tid)
			throws WeiboException
    {
		return FavoritesIds.constructFavoritesIds(client.get(WeiboConfig.getValue("baseURL") + "favorites/by_tags/ids.json", new PostParameter[]{new PostParameter("tid", tid)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return FavoritesIds.constructFavoritesIds(client.get(WeiboConfig.getValue("baseURL") + "favorites/by_tags/ids.json", parList, access_token));
	}
