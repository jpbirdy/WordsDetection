...
public class Account extends Weibo {
    ...
    public Privacy getAccountPrivacy() throws WeiboException {
        return new Privacy(client.get(WeiboConfig.getValue("baseURL") + "account/get_privacy.json", access_token));
    }
    ...
    public List<School> getAccountProfileSchoolList(Map<String, String> map) throws WeiboException {
        ...
        return School.constructSchool(
                client.get(WeiboConfig.getValue("baseURL") + "account/profile/school_list.json", parList,
                        access_token));
    }
    ...
    public RateLimitStatus getAccountRateLimitStatus() throws WeiboException {
        return new RateLimitStatus(
                client.get(WeiboConfig.getValue("baseURL") + "account/rate_limit_status.json", access_token));
    }
    ...
    public User endSession() throws WeiboException {
        return new User(client.get(WeiboConfig.getValue("baseURL") + "account/end_session.json", access_token));
    }
}
