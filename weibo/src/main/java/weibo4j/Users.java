...
public class Users extends Weibo {
    ...
    public User showUserByScreenName(String screen_name) throws WeiboException {
        return new User(client.get(WeiboConfig.getValue("baseURL") + "users/show.json", new PostParameter[]{
    ...
    public User showUserByDomain(String domain) throws WeiboException {
        return new User(client.get(WeiboConfig.getValue("baseURL") + "users/domain_show.json",
                new PostParameter[]{new PostParameter("domain", domain)}, access_token).asJSONObject());
    }
    ...
    public List<UserCounts> getUserCount(String uids) throws WeiboException {
        return UserCounts.constructUserCount(client.get(WeiboConfig.getValue("baseURL") + "users/counts.json",
