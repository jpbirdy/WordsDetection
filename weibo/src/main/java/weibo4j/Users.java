...
public class Users extends Weibo
{
    ...
    {
		return UserCounts.constructUserCount(client.get(WeiboConfig.getValue("baseURL") + "users/counts.json", new PostParameter[]{new PostParameter("uids", uids)}, access_token));
	}
}
