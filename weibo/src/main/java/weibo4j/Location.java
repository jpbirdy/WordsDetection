...
public class Location extends Weibo {
    ...
    {
		return Poisition
				.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_location.json", new PostParameter[]{new PostParameter("q", q)}, access_token));
	}
    ...
    {
		return Poisition
				.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_location.json", new PostParameter[]{new PostParameter("category", category)}, access_token));
	}
    ...
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Poisition.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_location.json", parList, access_token));
	}
	...
	public List<Poisition> searchPoisByAreaByQ(String q, String coordinates)
			throws WeiboException
    {
		return Poisition.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_area.json", new PostParameter[]{new PostParameter("q", q), new PostParameter("coordinates", coordinates)}, access_token));
	}
    ...
    {
		return Poisition.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_area.json", new PostParameter[]{new PostParameter("category", category), new PostParameter("coordinates", coordinates)}, access_token));
	}
			...
			throws WeiboException
    {
		PostParameter[] parList = ArrayUtils.mapToArray(map);
		return Poisition
				.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/search/by_area.json", parList, access_token));
	}
    ...
    {
		return Poisition.constructPois(client.get(WeiboConfig.getValue("baseURL") + "location/pois/show_batch.json", new PostParameter[]{new PostParameter("srcids", srcids)}, access_token));
	}
