...
public class UserCounts extends WeiboResponse {
    ...
    public String toString() {
        return "UserCount [" + "id=" + id + ", friends_count=" + friendsCount + ", followers_count=" + followersCount +
                ", statuses_count=" + statusesCount + ", private_friends_count=" + privateFriendsCount + "]";
    }
